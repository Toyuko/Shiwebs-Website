                ...
                <div class="row">
                    <div class="col-md-4 col-sm-4">
                        <div class="hk_single_part">
                            <div class="hk_icon">
                                <img class="hk_svg" src="images/icons/cloud_icon.svg" alt="">
                            </div>
                            <div class="hk_title">
                                <h4>Choose Your Plan</h4>
                            </div>
                            <p>Dedicated functionality including root access, but without the expense.</p>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-4">
                        <div class="hk_single_part">
                            <div class="hk_icon">
                                <img class="hk_svg" src="images/icons/icon5.svg" alt="">
                            </div>
                            <div class="hk_title">
            ...
            <div class="row">
                <div class="col-md-8 col-sm-7">
                    <div class="hk_promot_wrapper">
                        ...
                        <div class="hk_promot_btn"><a class="hk_btn" href="about_us.html">Know More</a></div>
                    </div>
                </div>
