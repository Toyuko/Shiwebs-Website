...
<body class="about_us">
    ...
    <!--================================
        2.END BREDCRAM AREA
    =================================-->
    <section class="hk_about_us_section hk_section_padding">
        <div class="container">
            <div class="col-md-6 col-sm-6 v_middle">
                <div class="hk_about_us_title">
                    <h1>About <span class="hk_highlited">Shiwebs</span></h1>
                    <p>We're in the business of hosting great ideas.</p>
                </div>
    ...
    <!--================================
        3.END SERVICE SECETION
    =================================-->
    <section class="hk_team_area hk_section_padding">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="hk_section_title reveal animated" data-anim-duration="0.3s" data-anim-delay="0" data-reveal-anim="fadeIn">
                        <h1>A Small Team With Amazing People</h1>
                        <p class="hk_title_subtext">Eu delicata rationibus usu. Vix te putant utroque, ludus fabellas duo eu, his dico ut debet consectetuer.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-3">
                    <div class="hk_single_team_member">
                        <div class="hk_team_img">
                            <img src="images/team1.jpg" alt="">
                        </div>

                        <div class="hk_name_deisg">
                            <p>Timh Bergstrom</p>
