                ...
                <div class="hk_breadcrumb_wrapper">
                    ...
                    <div class="hk_breadcrumb_area">
                        <ol class="breadcrumb">
                            ...
                            <li class="active">Infrastructure Service</li>
                        </ol>
                    </div>
                </div>
            </div>
	...
	<div class="row">
                <div class="col-md-12">
                    <div class="hk_section_title reveal animated" data-anim-duration="0.3s" data-anim-delay="0" data-reveal-anim="fadeIn">
                        <h1>We Provide <span class="title_highlight">Ideal Services</span>. Contact Us 
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="hk_promot_text">
                        <h2>Have a pre-sale question for our services?</h2>
                    </div>
