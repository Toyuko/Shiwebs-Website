...
<body class="contact-page">
    ...
    <!--================================
        3.START CONTACT AREA
    =================================-->
    <section class="hk_section_padding">
        <div class="container">
            <div class="row">
                <div class="col-md-5 col-sm-6">
                    <div class="hk_contact_address_wrapper">
                        <div class="hk_contact_area_title">
                        <h4>GET OFFICE INFO.</h4>
                    </div>
                    <div class="hk_contact_address">
                ...
                <div class="col-md-7 col-sm-6">
                    <div class="hk_contact_form_wrapper">
                        <div class="hk_contact_area_title">
                            <h4>GET IN TOUCH</h4>
                        </div>

                        <div class="hk_contact_form">
                            <div class="hk_form_wrapper">
                                <form action="#">
                                    <input type="text" class="hk_input_half_width hk_contact_input left" placeholder="First name*">
                                    <input type="text" class="hk_input_half_width hk_contact_input" placeholder="Last name">
                                    <input type="email" class="hk_input_half_width hk_contact_input left" placeholder="Email*">
                                    <input type="text" class="hk_input_half_width hk_contact_input" placeholder="Website">
                                    <textarea  class="hk_contact_input hk_message" cols="30" rows="5" placeholder="Message"></textarea>

                                    <input type="submit" class="hk_btn hk_message_btn" value="Submit">
                                </form>
                            </div>
                        </div>
                    </div>
...
All Rights Reserved
    ...
    <script>
        var myCenter=new google.maps.LatLng(40.656831, -73.883070);
        function initialize()
        {
            var mapProp = {
              center:myCenter,
